...
wget -q -O /usr/local/bin/wireproxy https://github.com/Pemulaajiw/AutoScript-XrayOnly/raw/main/wireproxy
...
XRAY_CONFIG=raw.githubusercontent.com/Pemulaajiw/AutoScript-XrayOnly/main/config
...
wget -q -O /var/www/html/index.html https://raw.githubusercontent.com/Pemulaajiw/AutoScript-XrayOnly/main/index.html
wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/Pemulaajiw/AutoScript-XrayOnly/main/nginx.conf
domain=$(cat /usr/local/etc/xray/dns/domain)
...
cd /usr/bin
GITHUB=raw.githubusercontent.com/Pemulaajiw/AutoScript-XrayOnly/main/
...
wget -q -O theme "https://${GITHUB}/xray/theme.sh"
